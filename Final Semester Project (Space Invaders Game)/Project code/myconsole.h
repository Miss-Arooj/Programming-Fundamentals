...
//Will get the width and height of current window
void GetWindowDimensions(int& width, int& height);

//use as alternative to above function. will get the maximum and minimum x and y coordinates of the current window
